    ...
    >
      <div className="container is-narrow">
        ...
        <h2 className="subtitle is-spaced">
          He estado trabajando en la industria de software durante más de una
          década. Echa un vistazo a mi experiencia.
        </h2>
            ...
            <div className="timeline-content">
              <div className="box">
                ...
                <div className="experience-box">
                  ...
                  <ul className="responsibilities-list">
                    <li>
                      <strong>Mentoring</strong> a compañeros y compañeras del
                      departamento que deseaban mejorar en su especialidad o
                    ...
                    <li>
                      Participación en la definición de arquitectura de
                      Front-End
                    </li>
                    <li>
            ...
            <div className="timeline-content">
              <div className="box">
                ...
                <div className="experience-box">
                  ...
                  <ul className="responsibilities-list">
                    <li>
                      <strong>Mentoría</strong> en la definición de proceso de
                      trabajo ágil y entrega contínua sostenible respaldado por
                      pruebas automáticas
                    </li>
                    <li>
                      Contribución en la definición de arquitectura en el
                      Front-End
                    </li>
            ...
            <div className="timeline-content">
              <div className="box">
                ...
                <div className="experience-box">
                  ...
                  <ul className="responsibilities-list">
                    <li>
                      <strong>Mentoring</strong> a compañeros de equipo en
                      desarrollo de software guiado por tests (
                      <a
                    ...
                    <li>
                      Facilitación y construcción de una comunidad de Front-End
            ...
            <div className="timeline-content">
              <div className="box">
                ...
                <div className="experience-box">
                  ...
                  <ul className="responsibilities-list">
                    <li>
                      Liderazgo tecnológico de uno de los equipos de producto
              ...
              <div className="box">
                ...
                <div className="experience-box">
                  ...
                  <p>
                    ...
                    , aprendiendo de grandes profesionales los fundamentos de
                    programación que luego me servirían durante el resto de mi
                    carrera profesional.
                  </p>
                </div>
              </div>
