      ...
      <div className="timeline-wrapper">
        <div className="timeline">
            ...
            <Box
              media={
                <a title="Workshare" target="_blank" rel="nofollow noopener" href="https://www.workshare.com/">
                  <img loading="lazy" width="263" height="67" alt="Workshare Logo" src="/images/workshare-logo.png" />
                </a>
              }
            >
              <p className="heading">De marzo 2018 a julio 2019</p>
              <h3>Senior Software Engineer at Workshare</h3>
              <ul>
                <li>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  ...
                  en .NET hacia una Single-Page Application desacoplada del Back-End implementada con React y basada en{" "}
                  <a
          ...
          <article className="timeline-item">
            <Box
              media={
                <a href="https://dotnet.microsoft.com/" title=".NET Framework" target="_blank" rel="nofollow noopener">
            ...
            >
              ...
              <p>
                ...
                , aprendiendo de grandes profesionales los fundamentos de programación que luego me servirían durante el
                resto de mi carrera profesional.
              </p>
            </Box>
          </article>
        </div>
